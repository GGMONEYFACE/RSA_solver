...
def block(message):
    """Print a message inside a boxed banner with blue text.
...
def greenblock(message):
    """Print a message inside a boxed banner with green text.
    ...
    for line in lines:
        print(f'##{GREENTEXT}{str(line).center(len(BARRIER)-4)}{RETURNDEFAULTCOLOR}##')
    print(BARRIER)